...
const About = () => {
    return (
        <section id="about">
            ...
            <span className='flex text-4xl justify-center  md:mt-[50px] lg:mt-[70px] mb-11'>ABOUT</span>
            <div className='justify-center mx-auto md:flex md:space-x-16 xl:space-x-28 space-y-8 md:space-y-0 w-[80vw] md:mt-16mb-16 md:mt-24 lg:mt-20'>
                <div className=''>
                    <img src={image} alt='photo' className="drop-shadow-[4px_3px_white] object-cover max-h-[400px] mx-auto min-w-[200px] md:-mt-6 lg:-mt-14" />
                </div>
