...
const About = () => {
    return (
        <section id="about">
            ...
            <span className='text-[#dfe5f0] flex text-2xl justify-center  md:mt-[50px] lg:mt-[70px]'>ABOUT</span>
            <div className='justify-center mx-auto md:flex md:space-x-16 xl:space-x-28 space-y-8 md:space-y-0 w-[80vw] mt-12 md:mt-16 h-[700px] md:h-[400px] lg:h-[500px]'>
                <div className=''>
