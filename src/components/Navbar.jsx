    ...
    return (
        <section className="" id="home">
            <div className="navbar px-8 py-[4vh] w-full flex justify-between tracking-wider shadow-lg fixed top-0 z-[2]" >
                ...
                <div onClick={() => setisOpen(!isOpen)} className="right-16 w-7 h-7 absolute cursor-pointer lg:hidden text-2xl transition-all duration-300 ease-out hover:text-white"> 
                    {
                ...
                {isOpen && (
                    <ul className={'flex active flex-col text-gray-500 w-[100vw] font-bold justify-between items-center fixed z-[3] lg:space-y-0 bg-[#1e2021] lg:bg-[#202224]] lg:border-0 border-2 border-[#202224] top-[11vh] lg:hidden'}>
